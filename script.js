...
const config = {
    serverInfo: {
        serverLogoImageFileName: "MosaicLand.png", /*This is a file name for logo in /images/ (If you upload new logo with other name, you must change this value)*/
        ...
        Vedení: [
            {
                ...
                rank: "Majitel",
                skinUrlOrPathToFile: "",
                rankColor: "rgb(41, 3, 255)"
            },
            {
                inGameName: "slaninapro",
                rank: "Majitel",
                skinUrlOrPathToFile: "",
                rankColor: "rgb(41, 3, 255)"
            },
            {
                inGameName: "24kgoldragon",
                rank: "Vedení Serveru",
                skinUrlOrPathToFile: "",
                rankColor: "rgb(130, 52, 255)"
            },
        ],
        developers: [
            {
